    ...
    return (
        <div>
            <div className="content">
                ...
                <h1>Hello! Welcome to my portfolio. </h1><br/>
                <h1>My name is Eric Wong and it is a pleasure to meet you!</h1>
                ...
                <h1>Thank you for looking at my portfolio, I look forward to meeting you!</h1>
